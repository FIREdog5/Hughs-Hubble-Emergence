...
public class Generation {
  public static void generateStars(World world, int count) {
    for (int i = 0; i < count; i++) {
      ...
      world.addWorldObject(new Planet(x, y, Palettes.earth1, ImageResources.generationTest));
    }
    world.addWorldObject(new Planet(0, 0, Palettes.earth1, ImageResources.generationTest));
    world.addWorldObject(new Planet(20, 20, Palettes.earth1, ImageResources.generationTest));
    world.addWorldObject(new Planet(-20, 20, Palettes.earth1, ImageResources.generationTest));
    world.addWorldObject(new Planet(-20, -20, Palettes.earth1, ImageResources.generationTest));
    world.addWorldObject(new Planet(20, -20, Palettes.earth1, ImageResources.generationTest));
  }
